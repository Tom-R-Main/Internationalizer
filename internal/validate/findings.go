...
const (
	...
	CodeICUMessageSyntax           FindingCode = "icu_message_syntax"
	CodeICUArgumentMismatch        FindingCode = "icu_argument_mismatch"
	CodeICUSelectorMismatch        FindingCode = "icu_selector_mismatch"
